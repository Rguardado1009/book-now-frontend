...
const EditAppointment = () => {
  ...
  useEffect(() => {
    fetch(`http://localhost:3000/appointments/${number}`).then((r) => {
      if (r.ok) {
        ...
        >
          <Container sx={{ width: "100%" }}>
            <Grid sx={{ width: "100%" }} spacing="2">
              <Card elevation={3}>
                <CardHeader title="My Appointment" />
                <p>
                  {error ? (
                    <>
                    ...
                    >
                      ...
                      >
                        <ListItem>
                          <ListItemText
                            primary="Service"
                            secondary={`${appointment.service.name}`}
                          />
                        </ListItem>
                        <ListItem>
                          <ListItemText
                        ...
                        <ListItem>
                          <ListItemText
                            primary="Engineer"
                            secondary={`${appointment.employee.name}`}
                          />
                        </ListItem>
                        <ListItem>
                          <ListItemText
                            primary="Rate"
                            secondary={`USD $ ${appointment.service.hourly_rate}`}
                          />
                        </ListItem>
                      </List>
                      ...
                      <Dialog open={open} onClose={handleClose}>
                        ...
                        <DialogContent>
                          ...
                          >
                            ...
                            >
                              <Checkbox
                                onChange={(e) => setCheckService(!checkService)}
                              />
                              <ListItem>
                                <ListItemText
                                  primary="Service"
                            ...
                            <LocalizationProvider dateAdapter={DateAdapter}>
                              <Stack direction="row">
                                <Checkbox
                                  onChange={(e) => setCheckDate(!checkDate)}
                                />
                                <DesktopDatePicker
                                  disabled={checkDate}
                                  label="Date"
                              ...
                              <Stack direction="row">
                                <Checkbox
                                  onChange={(e) => setCheckStart(!checkStart)}
                                />
                                <TimePicker
                                  disabled={checkStart}
                                  label="Start Time"
                              ...
                              <Stack direction="row">
                                <Checkbox
                                  onChange={(e) => setCheckEnd(!checkEnd)}
                                />
                                <TimePicker
                                  disabled={checkEnd}
                                  label="End Time"
