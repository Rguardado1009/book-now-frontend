...
export default function EmployeesCard({employee}) {
    ...
    return (
       ...
       <Card style={{color: '#292929', textAlign:'center'}} sx={{ maxWidth: 720, maxHeight: 1280}} elevation={6}>
        ...
        />
                <CardContent>
                <Typography component="h2">Known for working with: {employee.Knownfor} </Typography>
